...
// pointing at this Node executable and server entry; this builds it from
// fingerprinted, non-linked files and compares two descriptors for
// path-normalized equality so a "no-op" plan is trustworthy.
