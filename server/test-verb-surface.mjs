...
// Falling back to the pre-reorg path when a probe isn't found keeps the
// project-less/no-match behavior identical to before this change.
...
if (HAS_BP_DENSE) {
  ...
  skipFixture('bp_trace_exec: BP_OSPlayerR happy path', 'BP_OSPlayerR not found under project Content/');
}
...
if (HAS_BP_DENSE) {
  ...
  skipFixture('bp_trace_exec: max_depth cap', 'BP_OSPlayerR not found under project Content/');
}
...
if (HAS_BP_DENSE) {
  ...
  skipFixture('bp_trace_exec: pin_name filter', 'BP_OSPlayerR not found under project Content/');
}
...
if (HAS_BP_DENSE) {
  ...
  skipFixture('bp_trace_exec: error envelopes', 'BP_OSPlayerR not found under project Content/');
}
...
if (HAS_BP_DENSE) {
  ...
  skipFixture('bp_trace_exec: terminal/empty chain', 'BP_OSPlayerR not found under project Content/');
}
...
if (HAS_BP_DENSE) {
  ...
  skipFixture('bp_trace_data: happy path + error envelopes', 'BP_OSPlayerR not found under project Content/');
}
...
if (HAS_BP_DENSE) {
  ...
  skipFixture('bp_neighbors: both/in/out/self-loop', 'BP_OSPlayerR not found under project Content/');
}
...
if (HAS_BP_DENSE) {
  ...
  assert(r.available_fields.includes('pin_defaults'),
    'bp_show_node: pin_defaults now in available_fields when pin_block resolves');
  assert(!r.node.pins.some(p => p.default_object === null),
    'bp_show_node: default_object is omitted, not null, when no object default exists');
  ...
  if (HAS_BP_SMALL) {
    ...
    skipFixture('bp_show_node: literal fixture pin (TestCharacter)', 'TestCharacter not found under project Content/ (deleted from project)');
  }
} else {
  skipFixture('bp_show_node: M-new pin-block extension', 'BP_OSPlayerR not found under project Content/');
}
...
if (HAS_BP_DENSE) {
  ...
  skipFixture('bp_list_entry_points: has_no_exec_in precision', 'BP_OSPlayerR not found under project Content/');
}
...
if (HAS_BP_DENSE) {
  ...
  skipFixture('Oracle-A cross-check: BP_OSPlayerR EventGraph', 'BP_OSPlayerR not found under project Content/');
}
...
if (HAS_BP_SMALL) {
  ...
  skipFixture('Oracle-A cross-check: TestCharacter (small)', 'TestCharacter not found under project Content/ (deleted from project, not moved — D188)');
}
...
if (HAS_BP_DENSE) {
  ...
  skipFixture('bp_trace_exec: cycle safety invariant', 'BP_OSPlayerR not found under project Content/');
}
...
if (HAS_BP_DENSE) {
  ...
  skipFixture('FA-β manifest shape across all 5 verbs', 'BP_OSPlayerR not found under project Content/');
}
...
if (HAS_BP_DENSE) {
  ...
  skipFixture('F-2 input bridge: bp_list_entry_points → trace verbs', 'BP_OSPlayerR not found under project Content/');
}
...
if (HAS_BP_DENSE) {
  ...
  skipFixture('F-2 input bridge: per-verb dual-format equivalence', 'BP_OSPlayerR not found under project Content/');
}
...
if (HAS_BP_DENSE) {
  ...
  skipFixture('F-2 input bridge: SMOKE-FIX exhaustive regression', 'BP_OSPlayerR not found under project Content/');
}
